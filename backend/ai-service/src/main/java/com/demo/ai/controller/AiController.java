...
import com.demo.ai.orchestrator.ChatOrchestrator;
...
public class AiController {
  ...
  public AiController(ChatOrchestrator chatOrchestrator, AiService aiService, RagService ragService) {
  ...
  public ResponseEntity<ApiResponse<ChatResponse>> chat(@Valid @RequestBody ChatRequest chatRequest) {
    ChatResponse response = chatOrchestrator.chat(chatRequest);
  ...
  public Flux<String> chatStream(ChatRequest chatRequest) {
    ...
    return chatOrchestrator.chatStream(chatRequest);
  }
